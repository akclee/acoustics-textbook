...
const PAGE_CONTEXT: Record<string, string> = {
  ...
  '/chapters/01-introduction': 'Chapter 1: The World of Sound — soundscapes, spectra, noise, and the scope of acoustics',
  ...
  '/chapters/06-architectural': 'Chapter 6: Architectural Acoustics — room acoustics, BRIR, vibration isolation',
  '/chapters/07-demos': 'Chapter 7: Interactive Demos — SHM, equilibrium, damping, resonance, spectrograms',
}
...
export default function ChatBot() {
  ...
  const sendMessage = async () => {
    ...
    // Add empty assistant message — we'll stream text into it
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col z-50">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.length === 0 && (
              <div className="text-center text-gray-400 text-sm mt-8 px-4">
                ...
                <p>Ask me a question about what you're reading and I'll help you work through it.</p>
              </div>
            )}
          ...
          <div className="p-3 border-t border-gray-100">
            ...
            <p className="text-xs text-gray-400 mt-1.5 text-center">Enter to send · Tutor knows your current chapter</p>
          </div>
